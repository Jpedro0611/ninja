...
function Monstro(){
  if(World.frameCount%200===0){
    ...
    monstro.y=Math.round(random(50,550));
    monstro.x=Math.round(random(50,550));
    //a atualização abaixo fornece a linha de código para aumentar a velocidade do grupoMostro em 10
    monstro.lifetime=50; //  No lugar de setar o life time para o grupo, seta para o monstro que acabou de ser criado ta? E utiliza o lifetime.
...
function frutas(){
  if(World.frameCount%80===0){
    ...
    fruta.x=Math.round(random(50,550));
    
    fruta.lifetime=50; //  No lugar de setar o life time para o grupo, seta para o monstro que acabou de ser criado ta? E utiliza o lifetime.
